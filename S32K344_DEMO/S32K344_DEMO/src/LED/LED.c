 ...
 */
void LED_EnabledSubsystem1(boolean_T rtu_Enable)
{
...
void LED_step(void)
{
   ...
   *  Store in Global RAM
   */
  LED_EnabledSubsystem1(LED_B.CANFDUnpack_o1 > LED_DW.DelayInput1_DSTATE_b);
   ...
   *  Store in Global RAM
   */
  LED_EnabledSubsystem1(LED_B.CANFDUnpack_o2 > LED_DW.DelayInput1_DSTATE_e);
