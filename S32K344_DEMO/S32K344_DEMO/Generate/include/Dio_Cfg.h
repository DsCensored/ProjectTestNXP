...
/**
* @brief          Symbolic name for the port DioPort_PA16_PA31.
*
*/
#define DioConf_DioPort_DioPort_PA16_PA31  ((uint8)0x01U)



/**
* @brief          Symbolic name for the channel DioChannel_PA29.
*
*/
#define  DioConf_DioChannel_DioChannel_PA29 ((uint16)0x001dU)



/**
* @brief          Symbolic name for the channel DioChannel_PA30.
*
*/
#define  DioConf_DioChannel_DioChannel_PA30 ((uint16)0x001eU)



/**
* @brief          Symbolic name for the channel DioChannel_PA31.
*
*/
#define  DioConf_DioChannel_DioChannel_PA31 ((uint16)0x001fU)

/* ---------- DioPort_PB15_PB31 ---------- */

/**
* @brief          Symbolic name for the port DioPort_PB15_PB31.
*
*/
#define DioConf_DioPort_DioPort_PB15_PB31  ((uint8)0x03U)



/**
* @brief          Symbolic name for the channel DioChannel_PB18.
*
*/
#define  DioConf_DioChannel_DioChannel_PB18 ((uint16)0x0032U)

/* ---------- DioPort_PA00_PA15 ---------- */

/**
* @brief          Symbolic name for the port DioPort_PA00_PA15.
*
*/
#define DioConf_DioPort_DioPort_PA00_PA15  ((uint8)0x00U)



/**
* @brief          Symbolic name for the channel DioChannel_PA06.
*
*/
#define  DioConf_DioChannel_DioChannel_PA06 ((uint16)0x0006U)



/**
* @brief          Symbolic name for the channel DioChannel_PA07.
*
*/
#define  DioConf_DioChannel_DioChannel_PA07 ((uint16)0x0007U)
