...
const Clock_Ip_RegisterValueType Mcu_aClockRegisterValues[CLOCK_IP_REGISTER_VALUES_COUNT] = {
    {((uint32*)(IP_CMU_0_BASE + 0x04)),0x0},{((uint32*)(IP_CMU_0_BASE + 0x08)),0xffffff},{((uint32*)(IP_CMU_0_BASE + 0x0C)),0x0},{((uint32*)(IP_CMU_0_BASE + 0x14)),0x0},
    {((uint32*)(IP_CMU_3_BASE + 0x04)),0x0},{((uint32*)(IP_CMU_3_BASE + 0x08)),0xffffff},{((uint32*)(IP_CMU_3_BASE + 0x0C)),0x0},{((uint32*)(IP_CMU_3_BASE + 0x14)),0x0},
    {((uint32*)(IP_CMU_4_BASE + 0x04)),0x0},{((uint32*)(IP_CMU_4_BASE + 0x08)),0xffffff},{((uint32*)(IP_CMU_4_BASE + 0x0C)),0x0},{((uint32*)(IP_CMU_4_BASE + 0x14)),0x0},
...
static const Clock_Ip_DividerConfigType Clock_Ip_DividerConfigurations_0[CLOCK_IP_CONFIGURED_DIVIDERS_0_NO] = {
...

    {
        ...
        16000000U,
            ...
            4U,          /* End index in register values array */
        },
                            },
                                                                                                                                                                        {
        ...
        160000000U,
                                {
            4U,          /* Start index in register values array */
            8U,          /* End index in register values array */
        },
                            },
                                                                                                                                                                        {
        ...
        80000000U,
                                {
            8U,          /* Start index in register values array */
            12U,          /* End index in register values array */
        },
                            },
                                                };
...
const Clock_Ip_ClockConfigType Mcu_aClockConfigPB[1U] = {

    {
	    ...
	    0U,                                 /* The ID for Partition. */
                ...
                &Mcu_aClockRegisterValues,                                 /* Register data if register value optimization is enabled */
