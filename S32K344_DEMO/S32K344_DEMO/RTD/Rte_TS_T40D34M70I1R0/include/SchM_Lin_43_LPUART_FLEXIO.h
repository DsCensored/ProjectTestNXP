...
#define SCHM_LIN_43_LPUART_FLEXIO_AR_RELEASE_MINOR_VERSION     9
#define SCHM_LIN_43_LPUART_FLEXIO_AR_RELEASE_REVISION_VERSION  0
#define SCHM_LIN_43_LPUART_FLEXIO_SW_MAJOR_VERSION             7
#define SCHM_LIN_43_LPUART_FLEXIO_SW_MINOR_VERSION             0
#define SCHM_LIN_43_LPUART_FLEXIO_SW_PATCH_VERSION             1
