...
#define OS_AR_RELEASE_MINOR_VERSION     9   /* Minor version number of AUTOSAR specification       */
#define OS_AR_RELEASE_REVISION_VERSION  0   /* Patch level version number of AUTOSAR specification */

#define OS_SW_MAJOR_VERSION             7   /* Major version number of the implementation   */
