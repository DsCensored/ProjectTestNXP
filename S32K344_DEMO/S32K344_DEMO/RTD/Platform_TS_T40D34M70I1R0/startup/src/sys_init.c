...
#endif
#ifdef S32K356
    #include "S32K356_FXOSC.h"
    #include "S32K356_PMC.h"
    #include "S32K356_PLL.h"
    #include "S32K356_MC_CGM.h"
    #include "S32K356_MC_ME.h"
    #include "S32K356_FIRC.h"
    #include "S32K356_CONFIGURATION_GPR.h"
#endif
#ifdef S32K388
...
/*Partition 2*/
    ...
    #else   /* S32K389 */
        #define PRTN2_COFB2_CLKEN_REQ_MASK_U32      ((uint32)0xFFFFFF7BU)
    #endif
#else
    #define PRTN2_COFB0_CLKEN_REQ_MASK_U32      ((uint32)0x29FFFFF0U)
...
*  FLEXCAN8-11PE_CLK_Source = AIPS_SLOW_CLK, FLEXCAN8-11_PE_CLK = 40 MHz
...
#endif
#ifdef S32K389
    IP_MC_CGM->MUX_20_DC_0  &= ~MC_CGM_MUX_20_DC_0_DIV_MASK;
    IP_MC_CGM->MUX_20_DC_0  |= MC_CGM_MUX_20_DC_0_DIV(0U);    /* FLEXCAN8-11_PE_CLK */
#endif
...
#if 0 /* In S32K3/M27x platform, the DE bit of the MUX_0_DC_y registers in MC_CGM is read‑only and has a default value of “1”. No need to confifure DE bit. */
...
#endif
#ifdef S32K389
    IP_MC_CGM->MUX_20_DC_0  &= ~MC_CGM_MUX_20_DC_0_DE_MASK;
    IP_MC_CGM->MUX_20_DC_0  |= MC_CGM_MUX_20_DC_0_DE(1U);    /* FLEXCAN8-11_PE_CLK */
#endif
...
#endif
#ifdef S32K389
    IP_MC_CGM->MUX_20_CSC  &= ~MC_CGM_MUX_20_CSC_SELCTL_MASK;
    IP_MC_CGM->MUX_20_CSC  |= MC_CGM_MUX_20_CSC_SELCTL(22);      /* Select AIPS_PLAT_CLK (OUT: FLEXCAN8-11_PE_CLK) */
#endif
...
#endif
#ifdef S32K389
    IP_MC_CGM->MUX_20_CSC  &= ~MC_CGM_MUX_20_CSC_CLK_SW_MASK;
    IP_MC_CGM->MUX_20_CSC  |= MC_CGM_MUX_20_CSC_CLK_SW(1);
#endif
...
#endif
#ifdef S32K389
    while (0U == ((IP_MC_CGM->MUX_20_CSS  & MC_CGM_MUX_20_CSS_CLK_SW_MASK)  >> MC_CGM_MUX_20_CSS_CLK_SW_SHIFT))  {}
#endif
