...
#define MEM_43_INFLS_SOFTWARE_SEMAPHORE_AR_RELEASE_MINOR_VERSION        9
#define MEM_43_INFLS_SOFTWARE_SEMAPHORE_AR_RELEASE_REVISION_VERSION     0
#define MEM_43_INFLS_SOFTWARE_SEMAPHORE_SW_MAJOR_VERSION                7
#define MEM_43_INFLS_SOFTWARE_SEMAPHORE_SW_MINOR_VERSION                0
#define MEM_43_INFLS_SOFTWARE_SEMAPHORE_SW_PATCH_VERSION                1
