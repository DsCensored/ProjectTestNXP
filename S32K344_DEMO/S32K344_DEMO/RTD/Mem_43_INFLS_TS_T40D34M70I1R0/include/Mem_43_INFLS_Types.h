...
#if (MEM_43_INFLS_USED_IN_MEMORY_STACK == STD_ON)
...
#define MEM_43_INFLS_TYPES_AR_RELEASE_MINOR_VERSION       9
#define MEM_43_INFLS_TYPES_AR_RELEASE_REVISION_VERSION    0
#define MEM_43_INFLS_TYPES_SW_MAJOR_VERSION               7
#define MEM_43_INFLS_TYPES_SW_MINOR_VERSION               0
#define MEM_43_INFLS_TYPES_SW_PATCH_VERSION               1
...
#if (MEM_43_INFLS_HW_GETBLOCKNUMBER_SERVICE == STD_ON)
/**
 * @brief    Define ServiceId for get block from address
*/
#define MEM_43_INFLS_HWSERVICEID_ADDRESS_TO_BLOCK                    0x13U
#endif
...
/**
* brief          Size of data to be processed by CRC.
*/
typedef enum
{
...
#if (MEM_43_INFLS_USED_IN_MEMORY_STACK == STD_OFF)
/**
...
#else
/**
* @brief          Define JobResultType follow to MemAcc mem job result type
*
*/
#define Mem_43_INFLS_JobResultType     MemAcc_MemJobResultType
/* Re-define for Job Result Type */
#define MEM_43_INFLS_JOB_OK            MEM_JOB_OK
#define MEM_43_INFLS_JOB_PENDING       MEM_JOB_PENDING
#define MEM_43_INFLS_JOB_FAILED        MEM_JOB_FAILED
#define MEM_43_INFLS_INCONSISTENT      MEM_INCONSISTENT
#define MEM_43_INFLS_ECC_UNCORRECTED   MEM_ECC_UNCORRECTED
#define MEM_43_INFLS_ECC_CORRECTED     MEM_ECC_CORRECTED
#endif
...
typedef enum
{
    MEM_43_INFLS_INVALID_BLOCK      = 0x00U,  /*!< Invalid block identifier */
    MEM_43_INFLS_UTEST_BLOCK        = 0x01U,  /*!< block Utest         */
    MEM_43_INFLS_DATA_BLOCK         = 0x02U,  /*!< data block          */
    MEM_43_INFLS_CODE_BLOCK_0       = 0x03U,  /*!< code block number 0 */
    MEM_43_INFLS_CODE_BLOCK_1       = 0x04U,  /*!< code block number 1 */
    MEM_43_INFLS_CODE_BLOCK_2       = 0x05U,  /*!< code block number 2 */
    MEM_43_INFLS_CODE_BLOCK_3       = 0x06U,  /*!< code block number 3 */
    MEM_43_INFLS_CODE_BLOCK_4       = 0x07U,  /*!< code block number 4 */
    MEM_43_INFLS_CODE_BLOCK_5       = 0x08U,  /*!< code block number 5 */
    MEM_43_INFLS_CODE_BLOCK_6       = 0x09U,  /*!< code block number 6 */
    MEM_43_INFLS_CODE_BLOCK_7       = 0x0AU,  /*!< code block number 7 */
} Mem_43_INFLS_FlashBlocksNumberType;

typedef struct
{
    Mem_43_INFLS_AddressType                Address;
    Mem_43_INFLS_FlashBlocksNumberType      BlockNumber;
} Mem_43_INFLS_AddrToBlockConfigType;
#endif /*MEM_43_INFLS_HW_GETBLOCKNUMBER_SERVICE */
