...
#define MEM_43_INFLS_AR_RELEASE_MINOR_VERSION_C       9
#define MEM_43_INFLS_AR_RELEASE_REVISION_VERSION_C    0
#define MEM_43_INFLS_SW_MAJOR_VERSION_C               7
#define MEM_43_INFLS_SW_MINOR_VERSION_C               0
#define MEM_43_INFLS_SW_PATCH_VERSION_C               1
 ...
 *
 * @implements   Mem_43_INFLS_DoRequestedJobs_Activity
 *
 */
...
Mem_43_INFLS_JobResultType Mem_43_INFLS_GetJobResult(Mem_43_INFLS_InstanceIdType InstanceId)
{
    ...
    if (MEM_43_INFLS_MEM_INSTANCE_INDEX_INVALID != InstanceIndex)
    {
        /* Get the most recent job result of the according driver instance */
    ...
    {
        /* Report development error for invalid instance ID */
        ErrorId = MEM_43_INFLS_E_PARAM_INSTANCE_ID;
        Mem_43_INFLS_ReportDevError(InstanceId, MEM_43_INFLS_GET_JOB_RESULT_ID, ErrorId);
    }
#endif /* MEM_43_INFLS_DEV_ERROR_DETECT == STD_ON */
                                             ...
                                             )
{
    ...
    Mem_43_INFLS_AddrToBlockConfigType* pAddressToBlockConfig;
#endif
...
#if (MEM_43_INFLS_HW_GETBLOCKNUMBER_SERVICE == STD_ON)
            case MEM_43_INFLS_HWSERVICEID_ADDRESS_TO_BLOCK:
                pAddressToBlockConfig = (Mem_43_INFLS_AddrToBlockConfigType*)(uint32)dataPtr;
                RetVal = Mem_43_INFLS_IPW_AddressToBlock(pAddressToBlockConfig);
                break;
#endif
