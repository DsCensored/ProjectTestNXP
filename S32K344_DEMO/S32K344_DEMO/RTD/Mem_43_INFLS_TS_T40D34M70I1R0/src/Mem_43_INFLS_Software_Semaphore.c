...
#define MEM_43_INFLS_SOFTWARE_SEMAPHORE_AR_RELEASE_MINOR_VERSION_C        9
#define MEM_43_INFLS_SOFTWARE_SEMAPHORE_AR_RELEASE_REVISION_VERSION_C     0
#define MEM_43_INFLS_SOFTWARE_SEMAPHORE_SW_MAJOR_VERSION_C                7
#define MEM_43_INFLS_SOFTWARE_SEMAPHORE_SW_MINOR_VERSION_C                0
#define MEM_43_INFLS_SOFTWARE_SEMAPHORE_SW_PATCH_VERSION_C                1
