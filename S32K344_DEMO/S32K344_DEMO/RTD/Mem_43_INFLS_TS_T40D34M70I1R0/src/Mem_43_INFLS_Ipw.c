...
#define MEM_43_INFLS_IPW_AR_RELEASE_MINOR_VERSION_C            9
#define MEM_43_INFLS_IPW_AR_RELEASE_REVISION_VERSION_C         0
#define MEM_43_INFLS_IPW_SW_MAJOR_VERSION_C                    7
#define MEM_43_INFLS_IPW_SW_MINOR_VERSION_C                    0
#define MEM_43_INFLS_IPW_SW_PATCH_VERSION_C                    1
...
/**
 * @brief       Cancel an ongoing flash write and erase job.
 */
...
/**
 * @brief        Mem_43_INFLS_IPW_AddressToBlock
 * @details      Converts an address to its corresponding block number.
 */
Std_ReturnType Mem_43_INFLS_IPW_AddressToBlock(Mem_43_INFLS_AddrToBlockConfigType*  pAddressToBlockConfig)
{
    Std_ReturnType ReturnValue = E_OK;
    C40_Ip_FlashBlocksNumberType C40_Ip_Blocknumber;

    C40_Ip_Blocknumber = C40_Ip_GetBlockNumberFromAddress(pAddressToBlockConfig->Address);

    switch (C40_Ip_Blocknumber)
    {
    case C40_IP_CODE_BLOCK_0:
        pAddressToBlockConfig->BlockNumber = MEM_43_INFLS_CODE_BLOCK_0;
        break;
    case C40_IP_CODE_BLOCK_1:
        pAddressToBlockConfig->BlockNumber = MEM_43_INFLS_CODE_BLOCK_1;
        break;
    case C40_IP_CODE_BLOCK_2:
        pAddressToBlockConfig->BlockNumber = MEM_43_INFLS_CODE_BLOCK_2;
        break;
    case C40_IP_CODE_BLOCK_3:
        pAddressToBlockConfig->BlockNumber = MEM_43_INFLS_CODE_BLOCK_3;
        break;
    case C40_IP_CODE_BLOCK_4:
        pAddressToBlockConfig->BlockNumber = MEM_43_INFLS_CODE_BLOCK_4;
        break;
    case C40_IP_CODE_BLOCK_5:
        pAddressToBlockConfig->BlockNumber = MEM_43_INFLS_CODE_BLOCK_5;
        break;
    case C40_IP_CODE_BLOCK_6:
        pAddressToBlockConfig->BlockNumber = MEM_43_INFLS_CODE_BLOCK_6;
        break;
    case C40_IP_CODE_BLOCK_7:
        pAddressToBlockConfig->BlockNumber = MEM_43_INFLS_CODE_BLOCK_7;
        break;
    case C40_IP_DATA_BLOCK:
        pAddressToBlockConfig->BlockNumber = MEM_43_INFLS_DATA_BLOCK;
        break;
    case C40_IP_BLOCK_UTEST:
        pAddressToBlockConfig->BlockNumber = MEM_43_INFLS_UTEST_BLOCK;
        break;
    case C40_IP_BLOCK_INVALID:
        pAddressToBlockConfig->BlockNumber = MEM_43_INFLS_INVALID_BLOCK;
...
#endif /* MEM_43_INFLS_HW_GETBLOCKNUMBER_SERVICE == STD_ON */
