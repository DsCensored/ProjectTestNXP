...
## 
## Makefile     : LED.mk
## Generated on : Wed Jul 01 14:25:37 2026
...
START_DIR                 = D:/S32K344_DEMO2/MatlabModel
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/LED_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil
...
SRCS = $(START_DIR)/LED_ert_rtw/LED.c $(START_DIR)/LED_Ctrl.c $(START_DIR)/ADC_userCode.c
...
OBJS = LED.obj LED_Ctrl.obj ADC_userCode.obj
...
LED_Ctrl.obj : $(START_DIR)/LED_Ctrl.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


ADC_userCode.obj : $(START_DIR)/ADC_userCode.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
