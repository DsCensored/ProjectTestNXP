...
#define CAN_43_FLEXCAN_MAINFUNCTION_READ_PERIOD    (0.002F)
#define CAN_43_FLEXCAN_MAINFUNCTION_WRITE_PERIOD    (0.002F)

/**
*   @brief      Period for cyclic call of Main Function Mode
*/
#define CAN_43_FLEXCAN_MAINFUNCTION_MODE_PERIOD    (0.002F)
...
*/
#define Can_43_FLEXCANConf_CanHardwareObject_CanHardwareObject_RX_STD    ((Can_HwHandleType)0U)
#define Can_43_FLEXCANConf_CanHardwareObject_CanHardwareObject_RX_EXT    ((Can_HwHandleType)1U)
#define Can_43_FLEXCANConf_CanHardwareObject_CanHardwareObject_TX    ((Can_HwHandleType)2U)
