...
#define MEM_43_INFLS_AR_RELEASE_MINOR_VERSION_CFG_DEFINES            9
#define MEM_43_INFLS_AR_RELEASE_REVISION_VERSION_CFG_DEFINES         0
#define MEM_43_INFLS_SW_MAJOR_VERSION_CFG_DEFINES                    7
#define MEM_43_INFLS_SW_MINOR_VERSION_CFG_DEFINES                    0
#define MEM_43_INFLS_SW_PATCH_VERSION_CFG_DEFINES                    1
...
/* Define support used in memory stack */
#define MEM_43_INFLS_USED_IN_MEMORY_STACK                     (STD_ON)
...
/* Mem Hardware Get block number from address service*/
#define MEM_43_INFLS_HW_GETBLOCKNUMBER_SERVICE                (STD_ON)
