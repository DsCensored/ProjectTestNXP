...
/* Emios PWM mode configuration structure for PwmEmios_0/PwmEmiosChannels_EM0_CH17 */
const Emios_Pwm_Ip_ChannelConfigType Emios_Pwm_Ip_I0_Ch17 =
{
    /* .ChannelId */            17U,
    ...
    /* .InternalPs */           EMIOS_PWM_IP_CLOCK_DIV_10,
